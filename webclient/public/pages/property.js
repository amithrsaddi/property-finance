...
// src/pages/property.ts
var params = new URLSearchParams(window.location.search);
var propertyId = String(params.get("id") || "");
var user = getUser();
if (!propertyId || propertyId === "null") {
  window.location.href = "/properties.html";
}
var root = mountShell("/properties.html", "Property", "Loading\u2026");
root.innerHTML = `
  <section class="panel">
    <div class="filters">
